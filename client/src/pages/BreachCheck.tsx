        ...
        <motion.div variants={item} className="w-full max-w-xl space-y-6 text-center">
          ...
          <div className="glass-card rounded-2xl p-6 space-y-4">
            ...
            <div className="flex gap-3">
              ...
              <Button variant="outline" className="shrink-0" onClick={handleMonitorAccount} disabled={isMonitoring || !newEmail.trim()}>
                {isMonitoring ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : <Plus className="mr-2 h-4 w-4" />}
                Monitor
              </Button>
            </div>
          </div>
            ...
            <>
              ...
              <motion.div variants={item}>
                <div className="glass-card flex gap-3 rounded-2xl p-4">
                  ...
                  <Button className="shrink-0" onClick={handleMonitorAccount} disabled={isMonitoring || !newEmail.trim()}>
                    {isMonitoring ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : <Plus className="mr-2 h-4 w-4" />}
                    Monitor
                  </Button>
                </div>
