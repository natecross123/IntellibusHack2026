    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className={showCentered ? "flex min-h-[calc(100vh-8rem)] flex-col items-center justify-center" : "space-y-6"}>
      {showCentered ? (
        ...
        >
          ...
          <p className="text-muted-foreground mb-8">Upload an audio file or paste a URL to detect synthetic voice patterns</p>
          <Tabs defaultValue="upload" className="w-full">
            ...
            <TabsContent value="url">
              <div className="glass-card rounded-2xl p-6">
                <UrlInput
                  placeholder="Paste an audio URL, SoundCloud link, or podcast episode…"
        ...
        <>
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              {scannedUrl ? <>Scanned: <span className="text-primary">{scannedUrl}</span></> : "Upload an audio file to detect synthetic voice patterns"}
            </p>
          </div>
